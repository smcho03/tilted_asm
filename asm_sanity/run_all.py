"""run_all.py — run all asm_sanity checks in sequence"""
import sys
from pathlib import Path
from datetime import datetime
sys.path.insert(1, str(Path(__file__).parent.parent))  # append after asm_sanity/ to avoid shadowing
...
from sanity_06_gradient_descent   import run as r06
